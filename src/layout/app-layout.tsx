...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Menu', path: '/menus', entity: 'menu', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
  { name: 'Photo', path: '/photos', entity: 'photo', service: AccessServiceEnum.PROJECT, icon: FiImage },
